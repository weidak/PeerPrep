...
export default function ProfileCard({ name, email, image }: ProfileCardProps) {
    ...
    return (
        <>
            <Card className=" align-middle items-center justify-center w-72">
                <CardHeader className="">
                    <div className="flex flex-row items-center">
                        <div className="w-1/3 items-center pr-5">
                            <Image className="shadow-lg border rounded-3xl hover:cursor-pointer" src={image} onClick={() => {onImageClick()}}/>
